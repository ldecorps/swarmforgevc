...
Superseded by the specifier's resolution write-up: see
[BL-1251-handoff-blocked-by-task-scope-gate-20260829.md](BL-1251-handoff-blocked-by-task-scope-gate-20260829.md).
The `retires:` field was adopted over the `RETIRE-WITH`-marker predicate
suggested here.
