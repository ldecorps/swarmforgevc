...
## Disposition (specifier, 2026-09-13)

Specced 1:1 as **BL-1554** (`backlog/paused/BL-1554-qa-gathers-its-mechanical-checklist-in-one-call.yaml`,
feature `specs/features/BL-1554-qa-gathers-its-mechanical-checklist-in-one-call.feature`).
The operator's paragraph is quoted verbatim in the ticket's description.
QA.prompt's prose half landed in the same mint commit.
