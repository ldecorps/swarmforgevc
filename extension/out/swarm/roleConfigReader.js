...
exports.BOOTSTRAP_ROLE_CONFIGS = void 0;
exports.readRoleConfigs = readRoleConfigs;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
exports.BOOTSTRAP_ROLE_CONFIGS = [
...
function readRoleConfigs(targetPath) {
    const tsvPath = path.join(targetPath, '.swarmforge', 'roles.tsv');
    if (!fs.existsSync(tsvPath)) {
        return exports.BOOTSTRAP_ROLE_CONFIGS;
    }
    const configs = [];
...
//# sourceMappingURL=roleConfigReader.js.map