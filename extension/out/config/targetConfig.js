...
const targetPath_1 = require("./targetPath");
function getTargetPath() {
    const config = vscode.workspace.getConfiguration('swarmforge');
    return (0, targetPath_1.resolveTargetPath)({
        configuredTargetPath: config.get('targetPath'),
        workspaceFolders: vscode.workspace.workspaceFolders,
    });
}
async function setTargetPath(context) {
