...
exports.detectFooterLineCount = detectFooterLineCount;
exports.findOverlap = findOverlap;
exports.accumulatePaneHistory = accumulatePaneHistory;
...
function findOverlap(oldLines, newLines) {
...
function accumulatePaneHistory(previousContentLines, history, rawCaptureText, maxHistoryLines) {
    ...
    const appended = previousContentLines === null
        ? contentLines
...
//# sourceMappingURL=paneHistory.js.map