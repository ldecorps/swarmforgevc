...
export default {
  ...
  test: {
    ...cfg.test,
    // BL-1528 hardening: scope the Stryker dry run to the files this ticket
    // touched - avoids the standing Stryker-sandbox-only red in
