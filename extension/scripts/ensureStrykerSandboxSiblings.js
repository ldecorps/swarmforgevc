...
// path into. Confirmed instances: pwa/ (BL-221, asset reads) and
// swarmforge/ (BL-267, complianceBatteryGate.ts shelling compliance_battery.bb).
// Adding coverage for a new sibling is adding its name here.
const SIBLING_NAMES = ['pwa', 'swarmforge'];
