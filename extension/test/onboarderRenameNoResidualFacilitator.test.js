...
const ALLOWED_RESIDUAL_FILES = new Set([
  ...
  // Re-promoted hold/ -> active/ 2026-07-27 (ambulance released after BL-688
  // landed; BL-590 resumed at QA); filename keeps its old slug per boundary 2
  // above regardless of which backlog stage directory currently holds it.
  // See BL-694: this exact-path entry is fragile to stage moves by design
  // flaw, tracked there for a real fix; this is only the immediate unblock.
