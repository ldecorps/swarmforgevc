...
test('BL-589: decideCallbackQueryAction drops rule callback whose tail is not a numeric index', () => {
  const cq = mkCallbackUpdate({ fromId: PRINCIPAL_ID, data: 'rule:BL-589:label-not-index' }).callback_query;
