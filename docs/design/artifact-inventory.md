...
|----------|---------|------------------|-----------------|----------|
| Daily briefing email | Email (HTML + plain-text parts) | `swarmforge/scripts/briefing_email_lib.bb` (`render-briefing-html`), `extension/src/tools/render-briefing-diagrams.ts` | Send/inspect a real briefing render; `docs/how-to/BL-658-briefing-trigger-derived-from-closure-schedule.md` for when it fires | **2026-09-06 — approved** (BL-1419). One non-blocking follow-up: [list-item scan weight](briefs/2026-09-06-briefing-list-item-scan-weight.md), minted as BL-1442. |
