...
- **Trigger:** clearing occurs only after a role completes its current task/batch AND its queue returns NO_TASK (i.e., at the idle boundary, never mid-task or mid-batch)
