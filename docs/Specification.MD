...
|---|---|---|---|
| **1 — desktop only (v1)** | Default | Extension reads `.swarmforge/` files + streams the orchestrator's agent processes directly. No daemon. | ~none — this is essentially what exists |
