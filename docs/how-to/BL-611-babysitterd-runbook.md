...
| 2 | remote-control-flag | a live Claude process is missing `--remote-control` (Claude `/rc` only — seats with no RC flag are not degraded here; see BL-514 / BL-1108 for `rc:<role>: OFF`) |
