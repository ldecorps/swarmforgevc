...
- [Master-checkout drift mutes WARN while a commit is in flight](how-to/BL-1122-master-checkout-drift-mutes-warn-while-commit-in-flight.md) — `index.lock` mid-commit mute; durable reversion still alarms (BL-1122).
