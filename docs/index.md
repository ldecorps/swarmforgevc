...
- [Cold-swap day-shift to local Ollama mono-router](how-to/BL-1143-cold-swap-day-shift-ollama-qwen.md) — authorized cut-over off cursor-forge; verify then execute; rollback documented (BL-1143).
