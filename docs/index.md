...
- [Outage-driven seat failover via Model Steward](how-to/BL-669-outage-driven-seat-failover-via-steward.md) — sustained BL-650 outage → certified substitute at idle; auto-revert on close (BL-669).
...
- [/pilot's acceptance-contract landing gate](how-to/BL-727-pilot-acceptance-contract-gate.md) — BL-727 contract execution, BL-729 commit-claim, BL-731 multi-worktree fixture, BL-733 producer crosscheck, BL-735 acceptance-execution, BL-737 cross-file duplication
