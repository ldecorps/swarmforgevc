...
- [Reading context-compaction cadence trends](how-to/BL-601-trend-compaction-cadence.md) — comped/hr + token-at-compaction from structured `compaction:true` events only; NA when undetectable (BL-601; measures only).
