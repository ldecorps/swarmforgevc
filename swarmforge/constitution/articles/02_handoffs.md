...
**reference/02-handoffs-detailed.md** for the full pre-trim wording and two
...
summarizes it and must not diverge. See **reference/02-handoffs-detailed.md**
...
reserved/audit headers. See **reference/02-handoffs-detailed.md** for the
...
**reference/02-handoffs-detailed.md** for the full pre-trim wording.
...
**reference/02-handoffs-detailed.md** for this section's pre-trim wording.
...
- A `git_handoff` names ONE ticket. When a batch role's committed work
  ...
  See **reference/02-handoffs-detailed.md** and **workflow-detailed.prompt**
