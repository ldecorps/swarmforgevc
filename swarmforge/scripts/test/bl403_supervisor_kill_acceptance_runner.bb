#!/usr/bin/env bb
;; BL-403 acceptance test runner: executes check-one! with kill-pid! tracking
;; to verify that the supervisor kills the old pid before spawning the replacement.
;; Called from bl403SupervisorKillsSupersededChildSteps.js with a JSON scenario.
(ns bl403-supervisor-kill-acceptance-runner
...
;; Fixed pid for spawn - always returns 4242
(defn fixed-spawn! [] 4242)
