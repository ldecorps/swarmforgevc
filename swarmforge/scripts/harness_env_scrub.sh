...
harness_env_backend_provider_vars() {
  case "$1" in
    ...
    openrouter) printf '%s\n' OPENROUTER_API_KEY ;;
    aider) printf '%s\n' OPENAI_API_KEY MISTRAL_API_KEY CEREBRAS_API_KEY PERPLEXITY_API_KEY QWEN_API_KEY DASHSCOPE_API_KEY DEEPSEEK_API_KEY BAILIAN_API_KEY BAILIAN_CODING_PLAN_API_KEY BAILIAN_TOKEN_PLAN_API_KEY B_AI_API_KEY ;;
    *) return 1 ;;
  esac
}
