...
;; BL-1248 (shipped on main; BL-1247 duplicated the same feature and was
;; found colliding with it at this merge - see architect note) - config
;; kill switch guards only the :merge! adapter inside sweep! itself; the
;; drift/dirty-blocked surfacing and escalation paths above it in sweep!
;; still run even while disabled.
