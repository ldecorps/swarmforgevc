#!/usr/bin/env bash
# start-swarm-ollama-qwen3-8b.sh — local Ollama mono-router on qwen3-8b-q4km
# (sibling of start-swarm-ollama-qwen.sh, model swapped only; BL-1127/BL-1142).
...
bash "$SCRIPT_DIR/swarmforge/scripts/local_ollama_pack_shape_gate.sh" \
  "$SCRIPT_DIR" ollama-qwen3-8b-mono-router

export SWARMFORGE_PACK=ollama-qwen3-8b-mono-router
