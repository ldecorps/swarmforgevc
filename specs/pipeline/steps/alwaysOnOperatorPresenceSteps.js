...
const BL1277_FEATURE_NAME = "The Operator is always reachable, and being reachable never costs the swarm its recovery arm";
...
function registerSteps(registry) {
  ...
  // ── Background ───────────────────────────────────────────────────────
  bl1277Scoped(/^the swarm is running$/, () => {
