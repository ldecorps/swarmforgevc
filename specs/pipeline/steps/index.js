...
const DOMAINS = [
  ...
  require('./bl1274ReadinessNotARaceSteps'),
  require('./bl1062ReachFloorSatisfiableSteps'),
  ...
  require('./bl1339LandApprovalSharedRootSteps'),
  ...
  require('./bl545CatchUpPagerSteps'),
  ...
  require('./bl1080ChooseACursorSeatSteps'),
  require('./bl1082NamedModelServingSteps'),
  require('./bl1077DocumentedQwenCredentialNameSteps'),
  ...
  require('./bl737PilotCrossFileDuplicationGateSteps'),
  ...
  require('./bl1181BobStartingCastSteps'),
  ...
  require('./bl1024ExpediteNamesWhatItLeavesSteps'),
  require('./bl656ExpeditorPostsStageProgressSteps'),
  ...
  require('./bl1103OneSharedBoundedRunnerSteps'),
  ...
  require('./bl1127LocalCoderStewardEvidenceBarSteps'),
  ...
  require('./bl1133BabysitterdHeartbeatStartAndEndOfTickSteps'),
  ...
  require('./bl1184BriefingShiftVelocitySteps'),
  ...
  require('./bl1321SeatedPreferredYieldStampSteps'),
  require('./bl1334LandedReplayIsQaApprovedSteps'),
